...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002058292472').split() if id_pattern.search(auth_channel)]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_kottaaram2')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mk_movies_links')
...
PROTECT_CONTENT = is_disable((environ.get('PROTECT_CONTENT', "True")), True)
